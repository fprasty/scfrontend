...
const VillaSecondPages = () => {
  ...
  const getProducts = async (e) => {
    try {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/vlaall`);
  ...
  const deleteCookie = async () => {
    const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/vladelck`);
...
export default VillaSecondPages;

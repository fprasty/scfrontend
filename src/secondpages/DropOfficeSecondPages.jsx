...
const DropOfficeSecondPages = () => {
  ...
  const getProducts = async (e) => {
    try {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/doall`);
  ...
  const deleteCookie = async () => {
    const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/dodelck`);
...
export default DropOfficeSecondPages;

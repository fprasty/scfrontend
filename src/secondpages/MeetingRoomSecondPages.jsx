...
const MeetingRoomSecondPages = () => {
  ...
  const getProducts = async (e) => {
    try {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/mrall`);
  ...
  const deleteCookie = async () => {
    const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/mrdelck`);
...
export default MeetingRoomSecondPages;

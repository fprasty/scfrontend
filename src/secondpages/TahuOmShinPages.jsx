...
const TahuOmShinPages = () => {
  ...
  const getProducts = async (e) => {
    try {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/tosall`);
  ...
  const deleteCookie = async () => {
    const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/tosdelck`);
...
export default TahuOmShinPages;
